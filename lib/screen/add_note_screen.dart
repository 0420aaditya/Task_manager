      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            ...
            child: Padding(
              /// The line `padding: EdgeInsets.only(left: index == 0 ? 7 : 0),` is setting the left
              /// padding of the container based on the value of the `index` variable.
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    ...
                    color: indexx == index
                        ? custom_green
                        : Colors.grey, //tap garda glow hune
                  ),
                ),
                width: 140,
